...
extras_require_with_hooks = ["record-keeper >= 0.9.26", "faiss-gpu >= 1.6.3", "tensorboard"]
extras_require_with_hooks_cpu = ["record-keeper >= 0.9.26", "faiss-cpu >= 1.6.3", "tensorboard"]

...
class WeightRegularizerMixin(WeightMixin):
    def __init__(self, weight_regularizer=None, weight_reg_weight=1, **kwargs):
        self.weight_regularizer = weight_regularizer is not None #hack needed to know whether reg will be in sub-loss names
        super().__init__(**kwargs)
...
class EmbeddingRegularizerMixin:
    def __init__(self, embedding_regularizer=None, embedding_reg_weight=1, **kwargs):
        self.embedding_regularizer = embedding_regularizer is not None #hack needed to know whether reg will be in sub-loss names
        super().__init__(**kwargs)

        ...
        for dtype in TEST_DTYPES:
            for distance in [LpDistance(), CosineSimilarity()]:
                ...
                for margin_int in range(-1, 11):
                    ...
                    minerA = TripletMarginMiner(margin, type_of_triplets="all", distance=distance)
                    minerB = TripletMarginMiner(margin, type_of_triplets="hard", distance=distance)
                    minerC = TripletMarginMiner(margin, type_of_triplets="semihard", distance=distance)
                    minerD = TripletMarginMiner(margin, type_of_triplets="easy", distance=distance)
